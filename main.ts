...
// const current_users:string[] = ["usman","anika","mustafa","eisha","ashley"];
...
// let pizzaName:string[] = ["chicken tikka pizza","peproni pizza","cheese pizza"];
...
// }
// console.log("\n")
// console.log("I really like chicken tikka pizza.  ")
// console.log("I love  peprori pizza flavour.  ")
// console.log("Cheese pizza is most delicious then other.  ")
...
// for(let i=0; i <animal.length; i++){
//     if(animal[i] === "dog"){
//         console.log(`A ${animal[i]} is a loyal pet.`);
//     }else if(animal[i] === "cat"){
//         console.log(`A ${animal[i]} is a loving pet.`);
//     }else if(animal[i] === "parrot"){
//         console.log(`A ${animal[i]} is noisy pet. never make you boring.`)
//     }else{console.log("No pet found")}
// }
...
//     return `${size} ${message}`
// }
// let result = make_shirt("large", " It is available")
// console.log(result)
...
// make_shirt("small size","only small size available")
